...
public class InitParamServlet extends HttpServlet {
	...
	// http://localhost:8081/ServletDemo/initParam
	...
	public void init(ServletConfig config) throws ServletException {
		...
		// Lấy ra giá trị của tham số khởi tạo (initialization parameter) của
		// Servlet.
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// Lấy ra giá trị của tham số khởi tạo (initialization parameter) theo
		// một cách
		// khác.
