...
@WebServlet(urlPatterns = { "/annotationExample", "/annExample" }, initParams = {
        @WebInitParam(name = "emailSupport1", value = "AnnotationExampleServlet1@example.com"),
        @WebInitParam(name = "emailSupport2", value = "AnnotationExampleServlet2@example.com") })
public class AnnotationExampleServlet extends HttpServlet {
	...
	// http://localhost:8081/ServletDemo/annotationExample
    
	// http://localhost:8081/ServletDemo/annExample
